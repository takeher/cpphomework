...
{
	Solution sol;
	cout<<"encode is:"<<sol.encode("https://leetcode.com/problems/design-tinyurl")<<endl;
	cout<<"decode is:"<<sol.decode((sol.encode("https://leetcode.com/problems/design-tinyurl")))<<endl;
	return 0;
}
